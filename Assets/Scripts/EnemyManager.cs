...
public class EnemyManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Spawns in enemies with a delay until we reach spawn amount
    /// </summary>
    ...
    /// <summary>
    /// gets a random spawnpoint from list of spawns in current scene
    /// </summary>
    /// <returns>random spawnpoint</returns>
    public Transform GetRandomSpawn()
    {
        return spawnPoints[Random.Range(0, spawnPoints.Length)];
    }
    /// <summary>
    /// Gets a specific spawn point from list based on number given
    /// </summary>
    /// <param name="_spawnPoint">int position of spawnpoint in array</param>
    /// <returns>Transform of spawnpoint specified</returns>
    public Transform GetExactSpawnPoint(int _spawnPoint)
    {
    ...
    /// 
    /// </summary>
    /// <returns>Total number of spawn points in the scene</returns>
    public int GetSpawnPointCount() => spawnPoints.Length;
